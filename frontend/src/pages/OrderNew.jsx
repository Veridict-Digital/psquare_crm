...
const OrderNew = () => {
  ...
  const getFilteredProducts = () => {
    ...
    if (productFilters.category) {
      filtered = filtered.filter(product => product.category?.toString() === productFilters.category);
    }
  ...
  const calculateProductKPIs = () => {
    ...
    return products.map(product => {
      ...
      return {
        ...
        averagePrice,
        popularityScore,
        performance: popularityScore > 70 ? 'high' : popularityScore > 40 ? 'medium' : 'low'
      };
        ...
        {formData.customer && customerKPIs && (
          <div className="mb-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900">Customer 360° View</h2>
              <button
                onClick={() => setShowCustomerInsights(!showCustomerInsights)}
                className="ml-auto text-gray-500 hover:text-gray-700"
              >
                {showCustomerInsights ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
              </button>
            </div>
            {showCustomerInsights && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-blue-900">{customerKPIs.totalOrders}</div>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-green-900">₹{customerKPIs.totalValue.toLocaleString()}</div>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-purple-900">₹{customerKPIs.averageOrderValue.toLocaleString()}</div>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 hover:shadow-2xl transition-all duration-300">
            ...
            <div className="border-t pt-4">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <span className="text-sm font-medium text-gray-700">Quick Add Single Product</span>
              </div>
            ...
            {selectedProduct && (
              <div className="mt-8">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Related Combo Offers</h3>
                </div>
                  ...
                  if (relatedCombinations.length === 0) {
                    return (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-500">No combo offers available for this product</p>
                      </div>
                    );
                  }
                    ...
                    <div className="space-y-4">
                      {relatedCombinations.map((combo) => {
                        ...
                        const canApplyCombo = requiredItems.every(reqItem => {
                          const orderItem = orderItems.find(item => item.product === reqItem.product);
                          return orderItem && orderItem.quantity >= reqItem.quantity_required;
                        });
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {requiredItems.map((item, index) => {
                                    ...
                                    const hasEnough = inOrder && inOrder.quantity >= item.quantity_required;
                                    return (
                                      <span
                                        key={index}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-10 relative overflow-hidden">
              <div className="relative z-10 text-center">
                    ...
                    <div className="relative overflow-visible">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="flex space-x-1">
                          <div className="w-20 h-1 bg-gradient-to-r from-blue-300 to-transparent animate-pulse rounded-full" style={{ animationDelay: '0.6s', animationDuration: '0.3s' }}></div>
                          <div className="w-16 h-1 bg-gradient-to-r from-blue-400 to-transparent animate-pulse rounded-full" style={{ animationDelay: '0.7s', animationDuration: '0.3s' }}></div>
                          <div className="w-12 h-1 bg-gradient-to-r from-blue-500 to-transparent animate-pulse rounded-full" style={{ animationDelay: '0.8s', animationDuration: '0.3s' }}></div>
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-3 animate-fade-in drop-shadow-sm" style={{ animationDelay: '0.2s' }}>
                 ORDER SUCCESS!
                </h2>
